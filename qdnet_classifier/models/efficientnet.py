...
from qdnet.conf.config import MEAN, STD
...
default_cfgs = {
    ...
    'efficientnet_b1_pruned': _cfg(
        ...
        input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882, mean=MEAN, std=STD),
    'efficientnet_b2_pruned': _cfg(
        ...
        input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890, mean=MEAN, std=STD),
    'efficientnet_b3_pruned': _cfg(
        ...
        input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904, mean=MEAN, std=STD),
    ...
    'tf_efficientnet_b0_ap': _cfg(
        ...
        mean=MEAN, std=STD, input_size=(3, 224, 224)),
